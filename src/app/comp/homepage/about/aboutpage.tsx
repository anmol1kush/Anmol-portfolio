  ...
  return (
    ...
    >
      <div className="w-full max-w-7xl">
        ...
        >
         I'm a  Computer Science student with a passion for building complete, product-focused applications. I have practical experience developing full-stack solutions from concept to deployment, working across technologies like React, Node.js, and Java, as well as various databases including MongoDB and PostgreSQL.
         <br className="hidden sm:block" />
         <span className="sm:inline block mt-2 sm:mt-0">I enjoy tackling complex challenges, integrating AI APIs like Gemini, and implementing secure payment systems with Razorpay. I'm focused on writing clean, high-performance code to turn complex problems into simple and intuitive user experiences</span>
        </motion.p>
